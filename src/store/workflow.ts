...
const workflowSlice = createSlice({
  ...
  reducers: {
    ...
    updateNodeStartingPoint(
      state,
      action: PayloadAction<UpdateNodePositionData>
    ) {
...
export const { updateWorkflow, updateNodeStartingPoint, addNode } =
...
export const addBlock =
  (workflowBlock: WorkflowBlock) => (dispatch: any, getState: any) => {
